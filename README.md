...
# 1. Violin Strip plot
   Data you need 
      Features (X) : Boolean data of patterns with one dot (e.g. .AAAA: True, .AAAC: False ...) 
      & FRET values (Y) \\
...
# 2. Heatmap
      ...
      Data you need 
         Features (X) :  Boolean data of patterns with four dots (e.g. A....: True, T....: False ... )
         & FRET values (Y) \\
...
# 3. LASSO
      ...
      Data you need
         Features (X) : Boolean data of patterns with four dots (ex) A....: True, T....: False ... )
         & FRET values (Y) \\
...
# 4. Deep Learning
   ...
   Predict FRET values using AI models and compare results with a baseline (mean FRET as prediction)\
      ...
      Data you need : 
         Features (X) : Boolean data of patterns with four dots (ex) A....: True, T....: False ... ) \
         For MLP model, you can use various features such as features with three dots such as A.C.. : True , whatever you think meaningful.\
         & FRET value (Y) \\
